(function () {
  ...
  window.api = {
    ...
    startApplicationTool: (request) => backend().StartApplicationTool(request),
    ...
    diagnoseToolsByIDs: (itemIDs) => backend().DiagnoseToolsByIDs(itemIDs),
    autoFixTools: () => backend().AutoFixTools(),
    getConfigBackups: () => backend().GetConfigBackups(),
    createConfigBackup: () => backend().CreateConfigBackup(),
    restoreConfigBackup: (name) => backend().RestoreConfigBackup(name),
